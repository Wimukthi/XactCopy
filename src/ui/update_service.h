...
inline constexpr AppVersion kNativeVersion{0, 4, 0, 0};
...
public:
    ...
    static std::string download_asset(const std::string& download_url,
        ...
        HINTERNET session = WinHttpOpen(L"XactCopy/0.4.0-native", WINHTTP_ACCESS_TYPE_AUTOMATIC_PROXY,
                                        WINHTTP_NO_PROXY_NAME, WINHTTP_NO_PROXY_BYPASS, 0);
...
public:
    ...
    static UpdateReleaseInfo get_latest_release(const std::string& release_url) {
        ...
        std::wstring user_agent = L"XactCopy/0.4.0-native";
